...
const PostItem: Component<Props> = (props) => {
  ...
  return (
    <a
      ...
      class="pt-2 pb-2 px-4 flex items-center gap-3 sm:gap-5 rounded-2xl 
         hover:bg-[#FFD1E7] dark:hover:text-black
         transition-colors duration-150 ease-in-out"
    >
      <div class="flex items-center justify-center bg-[#FFD1E7] w-[44px] h-[44px] sm:w-[64px] sm:h-[64px] rounded-full">
        <span class="text-[28px] sm:text-4xl sm:pt-1.5">{post.data.imoji}</span>
      </div>
